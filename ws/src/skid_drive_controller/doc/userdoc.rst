:github_url: https://github.com/ros-controls/ros2_controllers/blob/{REPOS_FILE_BRANCH}/skid_drive_controller/doc/userdoc.rst

.. _skid_drive_controller_userdoc:
...
This controller uses the `generate_parameter_library <https://github.com/PickNikRobotics/generate_parameter_library>`_ to handle its parameters. The parameter `definition file located in the src folder <https://github.com/ros-controls/ros2_controllers/blob/{REPOS_FILE_BRANCH}/skid_drive_controller/src/skid_drive_controller_parameter.yaml>`_ contains descriptions for all the parameters used by the controller.

.. generate_parameter_library_details:: ../src/skid_drive_controller_parameter.yaml
  parameters_context.yaml

An example parameter file for this controller can be found in `the test directory <https://github.com/ros-controls/ros2_controllers/blob/{REPOS_FILE_BRANCH}/skid_drive_controller/test/config/test_skid_drive_controller.yaml>`_:

.. literalinclude:: ../test/config/test_skid_drive_controller.yaml
   :language: yaml
